    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published', models.DateTimeField(default=datetime.datetime(2023, 6, 23, 16, 3, 29, 45570), verbose_name='дата публикации')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='polls', to='polls.pollquestion', verbose_name='вопрос')),
            ],
            options={
                'verbose_name': 'анкета',
